...
{c2}           :/------------://        {results[0]}
{c2}        :------------------://      {results[1]}
{c2}      :-----------{c1}/shhdhyo/{c2}-://     {results[2]}
{c2}    /-----------{c1}omMMMNNNMMMd/{c2}-:/    {results[3]}
{c2}   :-----------{c1}sMMMdo:/{c2}       -:/   {results[4]}
{c2}  :-----------{c1}:MMMd{c2}-------    --:/  {results[5]}
{c2}  /-----------{c1}:MMMy{c2}-------    ---/  {results[6]}
{c2} :------    --{c1}/+MMMh/{c2}--        ---: {results[7]}
{c2} :---     {c1}oNMMMMMMMMMNho{c2}     -----: {results[8]}
{c2} :--      {c1}+shhhMMMmhhy++{c2}   ------:  {results[9]}
{c2} :-      -----{c1}:MMMy{c2}--------------/  {results[10]}
{c2} :-     ------{c1}/MMMy{c2}-------------:   {results[11]}
{c2} :-      ----{c1}/hMMM+{c2}------------:    {results[12]}
{c2} :--{c1}:dMMNdhhdNMMNo{c2}-----------:      {results[13]}
{c2} :---{c1}:sdNMMMMNds:{c2}----------:        {results[14]}
{c2} :------{c1}:://:{c2}-----------://         {results[15]}
{c2}  `-------------------:/            {results[16]}
{c2}                                    {results[17]}
\x1b[0m''',
'Debian': '''{c1}
{c2}        _,met$$$$$gg.        {results[0]}
{c2}     ,g$$$$$$$$$$$$$$$P.     {results[1]}
{c2}   ,g$$P""       """Y$$.".   {results[2]}
{c2}  ,$$P'              `$$$.   {results[3]}
{c2}',$$P       ,ggs.     `$$b:  {results[4]}
{c2}`d$$'     ,$P"'   .    $$$   {results[5]}
{c2} $$P      d$'     ,    $$P   {results[6]}
{c2} $$:      $$.   -    ,d$$'   {results[7]}
{c2} $$;      Y$b._   _,d$P'     {results[8]}
{c2} Y$$.    `.`"Y$$$$P"'        {results[9]}
{c2} `$$b      "-.__             {results[10]}
{c2}  `Y$$b                      {results[11]}
{c2}   `Y$$.                     {results[12]}
...
{c2} @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@/          {results[4]}
{c2} @@@@@@@@@@`                              {results[5]}
{c2} @@@@@@@@@@`   {c1}\ZZZZZZZL                  {results[6]}
{c2} @@@@@@@@@@`    {c1}\ZZZZZZZZZZZZZL           {results[7]}
{c2} @@@@@@@@@@`     {c1}}ZZZZZZZZZZZZZZZZZZZZD=  {results[8]}
{c2} @@@@@@@@@@`    {c1}/ZZZZZZZZZZZZZT           {results[9]}
{c2} @@@@@@@@@@`   {c1}/ZZZZZZZT                  {results[10]}
{c2} @@@@@@@@@@`                              {results[11]}
{c2} @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\          {results[12]}
{c2} @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\      {results[13]}
{c2} @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@O>  {results[14]}
...
class distroCheck(display):
    def render(self):
        try:
            ...
            distro = self.call_command("lsb_release -is").strip()
        else:
            distro = "Arch Linux"
...
def render_class(state, cls, args):
    """
    Returns the results of the run_command method for the class passed.
    """
    try:
